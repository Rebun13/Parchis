...
private:
  ...
  Vector2 exitWindowTextPosition = {surrenderAnchor.x + 20,
                                    surrenderAnchor.y + 50};
  const Rectangle buttonSurrender = {surrenderAnchor.x + 20,
                                     surrenderAnchor.y + 100, 190, 40};
  const Rectangle buttonCancel = {surrenderAnchor.x + 230,
                                  surrenderAnchor.y + 100, 190, 40};
  ...
  // Volume
  Rectangle settingsContainer = {settingsContainerAnchor.x,
                                 settingsContainerAnchor.y, 384, 240};
  float generalVolume = 1.0f;
  const Vector2 generalVolumeLabelCoord = {settingsContainerAnchor.x + 24,
                                           settingsContainerAnchor.y + 24};
  const Rectangle generalVolumeSlider = {
      settingsContainerAnchor.x + 24, settingsContainerAnchor.y + 48, 336, 36};
  float musicVolume = 1.0f;
  const Vector2 musicVolumeLabelCoord = {settingsContainerAnchor.x + 24,
                                         settingsContainerAnchor.y + 96};
  const Rectangle musicVolumeSlider = {
      settingsContainerAnchor.x + 24, settingsContainerAnchor.y + 120, 336, 36};
  float fxVolume = 1.0f;
  const Vector2 fxVolumeLabelCoord = {settingsContainerAnchor.x + 24,
                                      settingsContainerAnchor.y + 168};
  const Rectangle fxVolumeSlider = {settingsContainerAnchor.x + 24,
                                    settingsContainerAnchor.y + 192, 336, 36};
  // Buttons
