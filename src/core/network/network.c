...
// // UpdatePosMessage
// UpdatePosMessage *UpdatePosMessage_Create(void)
// {
//     return malloc(sizeof(UpdatePosMessage));
// }

// void UpdatePosMessage_Destroy(UpdatePosMessage *msg)
// {
//     free(msg);
// }

// int UpdatePosMessage_Serialize(UpdatePosMessage *msg, NBN_Stream *stream)
// {
//     NBN_SerializeUInt(stream, msg->client_id, 0, UINT_MAX);
//     NBN_SerializeUInt(stream, msg->token_id, 0, UINT_MAX);
