...
// #define PARCHIX_PROTOCOL_NAME "parchix"
// #define PARCHIX_PORT 42042
...
// UpdatePosMessage *UpdatePosMessage_Create();
// void UpdatePosMessage_Destroy(UpdatePosMessage *);
// int UpdatePosMessage_Serialize(UpdatePosMessage *msg, NBN_Stream *);

// TokenStatusMessage *TokenStatusMessage_Create();
// void TokenStatusMessage_Destroy(TokenStatusMessage *);
// int TokenStatusMessage_Serialize(TokenStatusMessage *msg, NBN_Stream *);

// GameStateMessage *GameStateMessage_Create();
