...
TokenStatusMessage *ChangePosMessage_Create(void);
void ChangePosMessage_Destroy(ChangePosMessage *);
int ChangePosMessage_Serialize(ChangePosMessage *msg, NBN_Stream *);
