...
// static void AcceptConnection(NBN_ConnectionHandle conn)
// {
//     NBN_WriteStream ws;
//     uint8_t data[32];
...
//     NBN_SerializeUInt((NBN_Stream *)&ws, x, BOARD_X, BOARD_X + BOARD_WIDTH);
//     NBN_SerializeUInt((NBN_Stream *)&ws, y, BOARD_Y, BOARD_Y + BOARD_HEIGHT);
...
//     AcceptConnection(client_handle);
...
//     std::basic_string strId = uuids::to_string(id);

//     // Fill the client state with initial spawning data
//     TokenState *tokens = [
//         {strId, strId + "_0", -1000.f, -1000.f, STATIC},
//         {strId, strId + "_1", -1000.f, -1000.f, STATIC},
//         {strId, strId + "_2", -1000.f, -1000.f, STATIC},
//         {strId, strId + "_3", -1000.f, -1000.f, STATIC}
//     ];

//     client->state = (ClientState){client_handle, client_count, 4, tokens};
